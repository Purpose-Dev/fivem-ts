/**
 * Enumeration representing the available radio stations.
 *
 * This enum provides a list of radio station identifiers that can be used
 * in applications requiring reference to specific radio stations.
 *
 * @enum{string}
 */
