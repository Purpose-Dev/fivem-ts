...
import { Entity, InvertAxisFlags } from '.';

/**
 * Represents a particle effect asset that can be used to manage and trigger particle
 */
export class ParticleEffectAsset {
	...
	public startLoopedAtCoords(
		...
		const invertAxisFlags: InvertAxisFlags = invertAxis.flags;
		UseParticleFxAsset(this.assetName);
		return Boolean(
	...
	public toJson(): string {
		return JSON.stringify({ assetName: this.assetName });
	}
}
