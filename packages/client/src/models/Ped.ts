import { Maybe, Nullable, Vector3, VehicleSeat, WeaponsHash } from '@fivem-ts/shared';
...
export class Ped extends Entity {
    private pedBones: Nullable<PedBoneCollection> = null;
    private drivingStyle: Maybe<DrivingStyle> = undefined;
    ...
    public get DrivingStyle(): DrivingStyle {
        return this.drivingStyle ? this.drivingStyle : DrivingStyle.Normal;
    }
     ...
     *
     * @returns {Vector3} The position where the last weapon impact occurred.
     */
