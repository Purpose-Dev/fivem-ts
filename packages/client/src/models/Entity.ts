import { Nullable, Vector3, WeaponsHash } from '@fivem-ts/shared';
import { EntityBone, EntityBoneCollection, Ped, Vehicle } from '.';
import { Blip, ForceType, Game, Model, Quaternion } from '..';
 ...
 */
export class Entity {
	protected bones: Nullable<EntityBoneCollection> = null;
	 ...
	 *
	 * @returns {number} The handle value as a number.
	 */
	 ...
	 *
	 * @returns {EntityBoneCollection} Entity Bone Collection of Entity
	 */
	public get Bones(): EntityBoneCollection {
		if (this.bones === null) this.bones = new EntityBoneCollection(this);
	 ...
	 *
	 * @returns {number} The network ID of the entity.
	 */
	 ...
	 *
	 * @returns {number} The maximum health of the entity.
	 */
	 ...
	 *
	 * @returns {boolean} Returns true if the entity is dead, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} Returns true if the entity is alive, otherwise false.
	 */
	 ...
	 *
	 * @returns {Model} A new instance of the Model class initialized with the entity model of the current handle.
	 */
	 ...
	 *
	 * @returns {Vector3} The position of the entity in 3D space.
	 */
	 ...
	 *
	 * @returns {Vector3} The rotation of the*/
	 ...
	 *
	 * @returns {Quaternion} The quaternion representing the entity's orientation.
	 */
	public get Quaternion(): Quaternion {
		const quaternion: [number, number, number, number] = GetEntityQuaternion(this.handle);
	 ...
	 *
	 * @returns {number} The heading of the entity.
	 */
	 ...
	 *
	 * @returns {Vector3} The rotation velocity of the entity.
	 */
	 ...
	 *
	 * @returns {number} The height of the entity above the ground.
	 */
	 ...
	 *
	 * @returns {number} The submersion level of the entity, where a higher value indicates a greater degree of submersion.
	 */
	 ...
	 *
	 * @returns {number} The LOD distance of the entity.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity is visible, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity is upright, false otherwise.
	 */
	 ...
	 *
	 * @returns {boolean} A boolean value indicating whether the entity is airborne.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity is in water, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity is persistent; otherwise, false.
	 */
	 ...
	 *
	 * @returns The opacity level as a number, where 0 represents fully transparent and 255 represents fully opaque.
	 */
	 ...
	 *
	 * @returns {boolean} Returns true if the entity has collided with anything, otherwise false.
	 */
	 ...
	 *
	 * @returns {Blip|null} The attached Blip instance or null if no valid blip exists.
	 */
	public get AttachedBlip(): Nullable<Blip> {
	 ...
	 *
	 * @returns {Blip} The newly created Blip associated with the entity.
	 */
	 ...
	 *
	 * @returns {boolean} - Returns true if there is a clear line of sight to the entity, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} - True if there is a clear line of sight to the target entity, false otherwise.
	 */
	 ...
	 *
	 * @returns {boolean} - Returns true if the current entity has been damaged by the specified entity, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} - Returns true if the entity has been damaged by the weapon, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity has been damaged by any weapon; otherwise, false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity has been damaged by any melee weapon; otherwise, false.
	 */
	 ...
	 *
	 * @returns {boolean} - Returns true if the entity is within the specified area, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} - True if the entity is within the angled area, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} Returns true if the given position is within the specified range, otherwise false.
	 */
	public isInRangeOf(position: Vector3, range: number): boolean {
		const v: Vector3 = this.Position.subtract(position);
	 ...
	 *
	 * @returns {boolean} - Returns true if the current entity is within the specified bounds of the target entity, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the current entity is touching the specified entity, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} - Returns true if the entity is touching the model, otherwise false.
	 */
	 ...
	 *
	 * @returns {Vector3} The new world position vector after applying the given offset.
	 */
	 ...
	 *
	 * @returns {Vector3} - The calculated position offset.
	 */
	 ...
	 *
	 * @returns {boolean} True if the entity is attached, otherwise false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the current entity is attached to the specified entity, false otherwise.
	 */
	 ...
	 *
	 * @returns {Entity} The entity that this entity is attached to.
	 */
	public getEntityAttachedTo(): Nullable<Entity> {
	 ...
	 * @returns {Ped | Vehicle | Prop | null} - The corresponding Ped, Vehicle, or Prop instance, or null if the handle does not map to a known entity type.
	 */
	public static fromHandle(handle: number): Nullable<Ped | Vehicle | Prop> {
	 ...
	 * @returns {Ped | Vehicle | Prop | null} - The entity corresponding to the given network identifier.
	 */
	public static fromNetworkId(networkId: number): Nullable<Ped | Vehicle | Prop> {
