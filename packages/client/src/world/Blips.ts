...
import { BlipColors, BlipDisplay, BlipScale, BlipType } from '../enums';
...
export class Blip {
   ...
   *
   * @return {boolean} True if the blip exists, otherwise false.
   */
   ...
   *
   * @return {BlipData} The data structure representing the created blip.
   */
   ...
   *
   * @return {BlipData} The data of the created blip.
   */
  public static createBlipFromRadius(
    ...
    const blip: Blip = new Blip(
      AddBlipForRadius(coords.x, coords.y, coords.z, radius)
    );
    return Blip.setBlipData(
      blip,
      'RADIUS',
  ...
  public static createBlipFromArea(
    ...
    const blip: Blip = new Blip(
      AddBlipForArea(coords.x, coords.y, coords.z, width, height)
    );
    return Blip.setBlipData(
      blip,
      'AREA',
   ...
   *
   * @return {BlipData} The data object containing all the blip settings.
   */
