...
import { CameraShake, Entity, PedBone } from '.';
...
export class Camera {
	 ...
	 *
	 * @returns {Vector3} The position of the camera.
	 */
	 ...
	 *
	 * @returns {Vector3} A Vector3 instance containing the rotation values (pitch, roll, yaw) of the camera.
	 */
	 ...
	 *
	 * @returns {Vector3} The normalized forward vector computed from the entity's rotation.
	 */
	 ...
	 *
	 * @returns {number} The field of view of the camera.
	 */
	 ...
	 *
	 * @returns {number} The near clipping distance of the camera.
	 */
	 ...
	 *
	 * @returns {number} The far clipping distance.
	 */
	 ...
	 *
	 * @returns {number} The near depth of field value.
	 */
	 ...
	 *
	 * @returns {number} The far depth of field value.
	 */
	 ...
	 *
	 * @returns {number} The strength of the depth of field effect.
	 */
	 ...
	 *
	 * @returns {boolean} True if the camera is shaking, false otherwise.
	 */
	 ...
	 *
	 * @returns {boolean} True if the object is currently interpolating; otherwise, false.
	 */
	 ...
	 *
	 * @returns {boolean} True if the camera exists, otherwise false.
	 */
