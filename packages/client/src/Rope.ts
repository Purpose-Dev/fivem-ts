...
export class Rope {
     ...
     *
     * @returns {number} The handle identifier.
     */
     ...
     *
     * @returns {number} The length of the rope.
     */
     ...
     *
     * @returns {boolean} True if the rope exists, otherwise false.
     */
     ...
     *
     * @returns {Vector3} A Vector3 object containing the x, y, and z coordinates of the vertex.
     */
