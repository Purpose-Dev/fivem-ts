import { Vehicle, VehicleWheel } from '.';
...
export class VehicleWheelCollection {
     ...
     *
     * @return {VehicleWheel} The wheel at the specified index.
     */
     ...
     *
     * @return {VehicleWheel[]} An array containing the vehicles with wheels attached.
     */
    public getAllVehicles(): VehicleWheel[] {
     ...
     *
     * @return {boolean} - Returns true if the vehicle has the specified wheel, otherwise false.
     */
